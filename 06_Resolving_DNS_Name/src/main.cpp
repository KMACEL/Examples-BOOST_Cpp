...
int main()
{
	...
	std::string host = "ardictech.com";
	std::string port_num = "9090";
	// Step 2.
	asio::io_service ios;
	...
	std::cout << it.operator*().endpoint() << std::endl;
	std::cout << it.operator*().service_name() << std::endl;
	std::cout << it.operator*().host_name() << std::endl;
