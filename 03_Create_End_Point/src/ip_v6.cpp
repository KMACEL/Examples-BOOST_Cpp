...
// The IP address is not provided because the server application usually 
// wants to listen for the incoming messages on all IP addresses available on the host, 
// not only on a specific one.
